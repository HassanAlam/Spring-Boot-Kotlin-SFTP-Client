...
data class LoginSettings(var loginDetails: LoginDetails = LoginDetails(), var id: String = "", var scheduledTime: String = "", var transactionType: String = "", var localDirectoryPath: String = "", var remoteDirectoryPath: String = "", var fileName: String = "",
